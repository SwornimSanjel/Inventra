...
inventra_guard_protected_view('admin/products', 'admin');
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions-col products-actions">
                                    <button type="button" class="icon-btn js-edit-product" title="Edit product" data-product='<?= htmlspecialchars(json_encode($product, JSON_HEX_APOS | JSON_HEX_AMP), ENT_QUOTES, 'UTF-8') ?>'>
                                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                                            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                                        </svg>
                                    </button>
                                    <button type="button" class="icon-btn icon-btn-danger js-delete-product" title="Delete product" data-id="<?= (int) $product['id'] ?>" data-name="<?= htmlspecialchars($product['name']) ?>">
                                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
