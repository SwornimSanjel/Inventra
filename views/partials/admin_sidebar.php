...
<aside class="sidebar">
  <div class="sidebar-brand">
    <span class="brand-logo">
      <img src="<?= $base ?>public/images/inventra-logo.png" alt="Inventra logo" class="brand-logo-img" width="32" height="32" style="width:32px;height:32px;object-fit:contain;display:block;">
    </span>
    <div>
  ...
  <nav class="sidebar-nav">
    ...
    <?php $active = (strpos($currentUrl, $item['url']) === 0 || ($item['url']==='admin/stock-update' && (strpos($currentUrl, 'admin/stock-in') === 0 || strpos($currentUrl, 'admin/stock-out') === 0))) ? 'active' : ''; ?>
  ...
  <div class="sidebar-bottom">
    <a href="<?= $base ?>login/logout.php" class="btn-logout">
