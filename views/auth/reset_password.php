<div class="auth-wrapper auth-login-wrapper">
    ...
    <div class="auth-login-layout">
        <div class="auth-card auth-flow-card">
            ...
            <h2 class="auth-flow-title">Set New Password</h2>
            <p class="auth-sub auth-flow-sub">Your OTP was verified. Create a new password below.</p>
            ...
            <form method="POST" action="index.php?url=auth/reset-password" class="auth-login-form">
