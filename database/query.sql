...
-- INSERT INTO admin (
--     id, full_name, email, password_hash, role, phone, avatar, notify_low_stock, notify_weekly_summary
-- ) VALUES (
--     1,
--     'Admin User',
--     'admin@inventra.com',
--     '$2y$10$n4UDXg9cqefcoZ6sOtKeseQvQZQcYgd1DiB3HnRcSXpHU/cYr4vOK',
--     'admin',
--     '9800000000',
--     NULL,
--     1,
...
--     id, category_id, name, category, qty, unit_price, lower_limit, upper_limit, image, description
-- ) VALUES
...
-- INSERT INTO users (
--     id, full_name, username, email, password, role, status
-- ) VALUES
-- (1, 'Admin User', 'admin', 'admin.staff@inventra.com', '$2y$10$n4UDXg9cqefcoZ6sOtKeseQvQZQcYgd1DiB3HnRcSXpHU/cYr4vOK', 'admin', 'active'),
...
--   password_hash = '$2y$10$n4UDXg9cqefcoZ6sOtKeseQvQZQcYgd1DiB3HnRcSXpHU/cYr4vOK',
...
-- SET
--     full_name = 'Admin User',
--     email = 'xettrikenzon@gmail.com',
--     password_hash = '$2y$10$372WvB9JUch0B7aLZdnRiugFLR4bYKxhw.XuU7LWcRs8Jy9GCSHdW',
--     role = 'admin'
-- WHERE id = 1;
...
-- SET
--     email = 'xettrikenzon@gmail.com',
--     password = '$2y$10$372WvB9JUch0B7aLZdnRiugFLR4bYKxhw.XuU7LWcRs8Jy9GCSHdW',
--     role = 'admin',
--     status = 'active'
-- WHERE id = 1;
...
--     'out',
--     1,
--     'Initial sample stock-out entry',
--     'Sample Customer',
--     '9800000001',
--     285000.00,
--     285000.00,
